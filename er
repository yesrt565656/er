...
function library.new(name, size)
	...
	function features:Slider(name, description, min, max, default, step, callback)
    name = name or "Slider"
    description = description or ""
    min = min or 0
    max = max or 100
    ...
    Value.Text = string.format("%.2f / %.2f", default, max)
